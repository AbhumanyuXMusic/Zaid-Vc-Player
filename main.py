...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO ALISHA SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of Alisha Music Started")
    print("[INFO]: STARTED THE ALISHA BOT AND SENDING THE INFO TO ALISHA SERVER")
